    ...
    return (
      <div className="tool-card static-width">
        <div className="user-name-and-score-div">
          <div className="tool-user-avatar-div">
            <img className="tool-avatar-img" src={photo} alt={name} />
          </div>
        ...
        <div className="tool-name-image-and-message-div">
          ...
          <div className="card-footer-buttons-div">
            <div
              ...
              onClick={() => this.handleToolVote("up")}
            >
              <FaRegThumbsUp />
              Upvote
            </div>
            <div
              ...
              onClick={() => this.handleToolVote("down")}
            >
              <FaRegThumbsDown />
              Downvote
            </div>
