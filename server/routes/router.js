...
router.route("/experts").get(getTopExperts);

router.route("/users/:user_id").get(getUser).put(putUser);

router.route("/users/:user_id/relevant").get(getRelevantInfo);

router.route("/users/:user_id/photos").put(putUserPhotos);

router.route("/users/:user_id/report").put(postReport);

router.route("/users/:user_id/handy/down").put(handyDown);

router.route("/users/:user_id/handy/up").put(handyUp);

router.route("/users/:user_id/tools").post(postTools);

router
  .route("/users/:user_id/tools/:tool_id")
  .put(putTools)
  .delete(deleteTools);

router.route("/users/:user_id/tools/:tool_id/photos").put(putToolPhotos);

router.route("/projects").get(getRecentProjects);

router.route("/users/:user_id/projects").post(postProjects);
...
router
  .route("/users/:user_id/projects/:project_id/photos")
  .put(putProjectPhotos);

router.route("/users/:user_id/projects/:project_id/needs").put(putNeeds);
...
router.route("/api/google/maps").get(getGoogleMapsAPI);
